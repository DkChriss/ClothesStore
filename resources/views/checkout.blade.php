                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="{{ route('checkout') }}" class="nav-item nav-link active">Facturacion y envío</a>
                            @auth
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="newaccount">Crear dirección</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="shipto">
                                            <label class="custom-control-label" for="shipto">Enviar producto a otra dirección</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="checkout-inner">
                            <div class="checkout-summary">
                                ...
                                <p class="ship-cost">Gastos de envío<span>Bs.</span></p>
