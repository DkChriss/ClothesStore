                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            <a href="{{ route('/') }}" class="nav-item nav-link active">Inicio</a>
                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-shopping-bag"></i>Más vendidos</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-plus-square"></i>Novedades</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-tshirt"></i>Ropa para hombres</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-tshirt"></i>Ropa para mujeres</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-mobile-alt"></i>Contactanos</a>
                                </li>
                    ...
                    <div class="col-md-6">
                        <div class="header-slider normal-slider">
                            ...
                            <div class="header-slider-item">
                                ...
                                <div class="header-slider-caption">
                                    <p>Tu mejor opcion en moda para un estilo autentico y vanguardista</p>
                                    <a class="btn" href=""><i class="fa fa-shopping-cart"></i>Compra ahora</a>
                                </div>
                            </div>
                            <div class="header-slider-item">
                        ...
                        <div class="header-img">
                            <div class="img-item">
                                ...
                                <a class="img-text" href="">
                                    <p>¡Todo lo  nuevo en moda y estilo lo encuentras aqui!</p>
                                </a>
                            </div>
                            <div class="img-item">
                                <img src="img/category-2.jpg" />
                                <a class="img-text" href="">
                                    <p>Deslumbra a todos con tu belleza y destaca con las prendas que nos acaban de llegar.</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6 feature-col">
                        <div class="feature-content">
                            ...
                            <h2>Pago seguro</h2>
                            <p>
                                Tenemos metodos de pago seguro para ti.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-col">
                        <div class="feature-content">
                            ...
                            <p>
                                Estamos en todo el Pais. ¡Hacemos envios a toda Bolivia!.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-col">
                        <div class="feature-content">
                            ...
                            <h2>Devoluciones</h2>
                            <p>
                                Aceptamos devoluciones hasta 24 horas despues de la compra.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 feature-col">
                        <div class="feature-content">
                            ...
                            <h2>Atención 24/7</h2>
                            <p>
                                Estamos a tu disposición, no importa el dia ni la hora.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            ...
                            <a class="category-name" href="">
                                <p>Conjuntos de ropa en pareja.</p>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="category-item ch-250">
                            ...
                            <a class="category-name" href="">
                                <p>Camina como una modelo de pasarela con nuestras variedad en ropa.</p>
                            </a>
                        </div>
                        <div class="category-item ch-150">
                            <img src="img/category-5.jpg" />
                            <a class="category-name" href="">
                                <p>Estilos para toda ocasión.</p>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="category-item ch-150">
                            ...
                            <a class="category-name" href="">
                                <p>le desimos adios a la temporada, apurate y aprovecha nuestros descuentos.</p>
                            </a>
                        </div>
                        <div class="category-item ch-250">
                            <img src="img/category-7.jpg" />
                            <a class="category-name" href="">
                                <p>Camina como una modelo de pasarela.</p>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            ...
                            <a class="category-name" href="">
                                <p>variedad de vestidos de todos los estilos.</p>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="call-to-action">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <a href="tel:60722803">+591 60722803</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            <div class="product-title">
                                <a href="#">Vestido largo de seda</a>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            <div class="product-title">
                                <a href="#">camisa cuello clasico</a>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
        ...
        <div class="newsletter">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form">
                            <input type="email" value="tu correo electronico aqui">
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            <div class="product-title">
                                <a href="#">blusa con cuello caido</a>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            <div class="product-title">
                                <a href="#">vestido blanco casual</a>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            ...
                            <div class="review-text">
                                ...
                                <p>
                                   Encargada del departamento de Marketing
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            ...
                            <div class="review-text">
                                ...
                                <p>
                                    Encargado del manejo de la empresa y co-fundador.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            ...
                            <div class="review-text">
                                ...
                                <p>
                                   Encargada del departamentro de Recursos Humanos
                                </p>
                            </div>
                        </div>
                    </div>
